package com.challenge.geosapiens.service_a.application.helper;
...
public class RequestCounterHelper {
    ...
    private final AtomicInteger deliveryPersonCreateCounter = new AtomicInteger(0);
    ...
    public boolean shouldFailDeliveryPersonCreate() {
        int count = deliveryPersonCreateCounter.incrementAndGet();
        log.info("DeliveryPerson CREATE request count: {}", count);
        return count > 3;
    }
    ...
    public void resetCounters() {
        ...
        deliveryPersonCreateCounter.set(0);
